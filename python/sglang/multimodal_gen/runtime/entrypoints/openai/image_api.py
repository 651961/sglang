...
async def generations(
    ...
    with temp_dir_if_disabled(server_args.output_path) as output_dir:
        sampling = build_sampling_params(
            ...
            cfg_scale=_get_request_field_or_extra(request, "cfg_scale"),
            cfg_norm=_get_request_field_or_extra(request, "cfg_norm"),
            timestep_shift=_get_request_field_or_extra(request, "timestep_shift"),
            t_eps=_get_request_field_or_extra(request, "t_eps"),
...
async def edits(
    ...
    img_cfg_scale: Optional[float] = Form(None),
    cfg_norm: Optional[str] = Form(None),
    timestep_shift: Optional[float] = Form(None),
    t_eps: Optional[float] = Form(None),
    target_pixels: Optional[int] = Form(None),
    input_max_pixels: Optional[str] = Form(None),
